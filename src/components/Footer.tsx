      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div className="space-y-4">
          ...
          <p className="text-xs text-slate-400 leading-relaxed font-sans">
            {replaceCompanyText('Taranet adalah provider internet berkualitas yang berkomitmen menyediakan 100% layanan Internet Fiber To The Home (FTTH). Menghubungkan Anda ke dunia luar dengan kecepatan tinggi, stabil, dan aman.', companyName)}
          </p>
      ...
      <div className="fixed bottom-6 right-6 z-40">
        ...
        >
          <span className="absolute right-14 bg-slate-900 text-white text-[11px] font-bold py-1.5 px-3 rounded-lg shadow border border-slate-800 whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
            {replaceCompanyText('Hubungi Customer Service Taranet 24 Jam', companyName)}
          </span>
          {/* Pulsing glow ring */}
