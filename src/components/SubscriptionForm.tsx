      ...
      <div className="bg-white rounded-3xl border border-slate-200/80 shadow-2xl overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-blue-900 to-indigo-950 p-6 sm:p-8 text-white text-center sm:text-left flex flex-col sm:flex-row justify-between items-center gap-4">
          <div className="space-y-1.5">
            ...
            <p className="text-xs text-blue-200">Isi data lengkap Anda untuk pengajuan pemasangan WiFi baru {replaceCompanyText('Taranet', companyName)}.</p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-[10px] text-slate-400 mt-1">Gunakan password ini untuk masuk ke dasbor portal pelanggan {replaceCompanyText('Taranet', companyName)}.</p>
              </div>
            </div>
          </div>
